  ...
  const handleSubmit = async (e) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        setErrors({
          email:
            "Đăng ký thất bại. Email đã tồn tại hoặc dữ liệu không hợp lệ.",
        });
        setLoading(false);
      }
    }
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between py-1">
              <span className="text-gray-600 text-sm">
                ...
                <Link
                  to="/login"
                  className="text-blue-600 hover:text-blue-700 font-semibold ml-1 hover:underline transition-all duration-200"
                >
                  Đăng nhập
                </Link>
              </span>
            ...
            <div className="grid grid-cols-3 gap-6">
              <div className="text-center group">
                ...
                <p className="text-sm text-blue-200 leading-relaxed">
                  Tài khoản ẩn danh, dữ liệu bảo mật
                </p>
              </div>
              <div className="text-center group">
                <div className="w-16 h-16 bg-white/20 backdrop-blur-sm rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-all duration-300 border border-white/30">
